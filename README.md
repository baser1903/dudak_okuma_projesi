...
<br/>
Modelin tamamı ve uygulaması, modeli oluşturduğumuz [final.ipynb](Model.ipynb) dosyasındadır. Dosyada Görüntü veri üreteci, çeşitli CNN katmanları, analiz bölümü bulunmaktadır.
<br/>
Model şu şekildedir:
```
model = Sequential()
